...
<div class="container-fluid">
    <center><h2>Importador Datos</h2></center>
    <br>
    <div class="row">
        <div class="col-md-1"></div>
        <div class="col-md-10">
            <div class="panel panel-primary">
                <div class="panel-heading">Importar Datos</div>
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div id="imgImport">
                            <br>
                            <center>
                                <img src="datos.jpeg" alt="" width="70%" >
                            </center>
                        </div>
                        <br>
                        ...
                        <button id="btn_registrar" class="btn btn-info">Registrar Datos</button>
...
<script>
    $('#btn_registrar').click(function () {
        ...
        $('#my_file_output tr').each(function () {
            ...
            console.log (valor);
           // alert(valor);
            $.post('insertar.php', {d1:d1, d2:d2, d3:d3, d4:d4, d5:d5, d6:d6}, function (datos) {
