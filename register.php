...
<div class="container">
  ...
  <form class="form-horizontal" method="post" action="add_user.php">
    ...
    <div class="form-group">
      <label class="control-label col-sm-2 col-sm-offset-2" for="password">Clave:</label>
      <div class="col-sm-5">          
        <input type="password" class="form-control" id="password" placeholder="Ingresa una clave" name="password" required>
      </div>
    </div>    
    <div class="form-group">        
